...
function ret = local_unID_VAR(Am,Su,q)
...
S_Yn=Ry(1);     % variance of the process
S_Ynq=toeplitz(Ry(1:q),Ry(1:q));    % covariance matric of the past of the process (toeplitz's matrix)
S_Yn_Ynq=Ry(2:q+1);         % cross-covariance matric of present and past of the process
% S_Ynq_Yn=S_Yn_Ynq';
S_YnYnq=[[S_Yn S_Yn_Ynq];[S_Yn_Ynq' S_Ynq]];    % joint covariance matrix of present and past of the process

Sy=0.5*log((S_Yn*det(S_Ynq))/det(S_YnYnq));     % global IS
